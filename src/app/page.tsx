  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center text-center text-white bg-gray-800">
        <Image
          src="/nkins.png"
          alt="Premium men's suits and accessories"
          layout="fill"
          objectFit="cover"
        ...
        <div className="relative z-10 p-4 bg-black bg-opacity-30 rounded-lg">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-headline drop-shadow-lg">
            First Class Style, Every Time
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl font-body drop-shadow-md">
            Premium suits, trousers, and accessories — quality you can trust at Gifto Boutique, Uyo.
          </p>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2">Handpicked suits and accessories, just for you.</p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2">Trusted by our customers, perfect for the modern gentleman.</p>
            </div>
